  ...
  return (
    <div className="p-4 md:p-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
        ...
        <button className="bg-green-600 flex items-center gap-2 text-white font-bold px-4 py-2 rounded-lg hover:bg-green-700 transition">
          <FaPlus /> New Booking
        </button>
      </div>
      ...
      <div className="overflow-x-auto bg-white rounded-xl shadow-sm">
        <table className="w-full min-w-[700px]">
          <thead className="text-left border-b text-green-900 uppercase text-sm">
            <tr>
            ...
            {currentBookings.map((book) => (
              <tr key={book.id} className="border-b hover:bg-gray-50 transition">
                ...
                <td className="p-4 flex gap-3 items-center">
                  <button><FaEdit className="text-green-600 cursor-pointer hover:text-green-700" /></button>
                  <button><FaTrash className="text-red-600 cursor-pointer hover:text-red-700" /></button>
                </td>
              </tr>
            ))}
          </tbody>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mt-3 gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="px-3 py-1 border rounded-md text-sm text-gray-700">{currentPage}</span>
